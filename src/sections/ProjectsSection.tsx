...
export default function ProjectsSection() {
  ...
  return (
    ...
    >
      ...
      {projects.map((project, index) => {
        ...
        return (
          <div
            ...
            className="absolute mt-8 group top-1/2 left-1/2 w-[80%] origin-bottom max-[1000px]:w-[calc(100%-1.5rem)] sm:max-[1000px]:w-[calc(100%-2.5rem)]"
          >
            <div
            ...
            >
              ...
              <div className="md:hidden flex flex-col h-full">
                ...
                >
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    {/* Status dot */}
                    <span
                      className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full border text-[8px] font-mono tracking-wide ${s.text} ${s.border} ${s.bg}`}
                    >
                ...
                <div className="flex flex-col flex-1 min-h-0 px-4 pt-2.5 pb-3">
                  ...
                  <div
                    className="absolute -bottom-1/3 left-2 b-400 w-[95%] mx-auto shrink-0"
                    style={{ height: "100%" }}
                  >
                    {project.image && (
                      <Image
              ...
              <div className="hidden md:flex flex-col h-full">
                ...
                >
                  ...
                  <div
                    className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full border font-mono text-[10px] tracking-wide shrink-0 ${s.text} ${s.border} ${s.bg}`}
                  >
                    <span className="relative flex h-1.5 w-1.5 shrink-0">
                      {project.status !== "archived" && (
                        <span
                    ...
                    {STATUS_CONFIG[project.status].label === "Live"
                      ? "Currently Working"
                  ...
                  >
                    <div className="flex flex-col p-14 w-3/5 lg:w-1/2 min-h-0">
                      ...
                      <h3
                        ...
                        className="text-5xl lg:text-6xl font-bold uppercase leading-none mb-4"
                      >
                        {project.title}
                      </h3>
                      <div
      ...
      <div
        className="absolute bottom-0 left-0 w-full h-24 pointer-events-none z-50"
